...
struct clkctl_acpu_speed acpu_freq_tbl[] = {
        ...
        { 268800, CCTL(CLK_TCXO, 1),            SRC_SCPLL, 0x07, 0, 1000, 58000 },
        { 307200, CCTL(CLK_TCXO, 1),            SRC_SCPLL, 0x08, 0, 1000, 58000 },
        { 345600, CCTL(CLK_TCXO, 1),            SRC_SCPLL, 0x09, 0, 1025, 58000 },
